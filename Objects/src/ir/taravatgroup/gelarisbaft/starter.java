...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "ir.taravatgroup.gelarisbaft", "ir.taravatgroup.gelarisbaft.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.taravatgroup.gelarisbaft.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
