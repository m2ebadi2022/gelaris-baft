...
public class httputils2service extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "ir.taravatgroup.gelarisbaft", "ir.taravatgroup.gelarisbaft.httputils2service");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.taravatgroup.gelarisbaft.httputils2service", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public ir.taravatgroup.gelarisbaft.main _main = null;
public ir.taravatgroup.gelarisbaft.starter _starter = null;
public static String  _completejob(int _taskid,boolean _success,String _errormessage) throws Exception{
ir.taravatgroup.gelarisbaft.httpjob _job = null;
...
_job = (ir.taravatgroup.gelarisbaft.httpjob)(_taskidtojob.Get((Object)(_taskid)));
...
anywheresoftware.b4a.keywords.Common.LogImpl("5851974","HttpUtils2Service: job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("5786433",("ResponseError. Reason: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_reason))+", Response: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_response.getErrorResponse()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("5786437","HttpUtils2Service (hc_ResponseError): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("5655363","HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("5393223",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 //BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
anywheresoftware.b4a.keywords.Common.LogImpl("5393224","Switching to File.DirInternal",0);
...
public static String  _submitjob(ir.taravatgroup.gelarisbaft.httpjob _job) throws Exception{
int _taskid = 0;
